...
(101, 'DBMS', 'Bobin'),
(102, 'Operating Systems', 'Ansamol'),
(103, 'Graph Theory', 'Jitty'),
(104, 'Theory of Computation', 'Aswin');
...
INSERT INTO `student` (`student_id`, `name`, `department`, `semester`) VALUES
(1, 'Milan Thomas', 'cse', 4),
(101, 'Milan Thomas', 'cse', 4);
...
('root', '[{\"db\":\"attendance_db\",\"table\":\"attendance\"}]');
...
('root', '2026-03-26 16:00:04', '{\"Console\\/Mode\":\"collapse\"}');
